...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-choroplethr-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-choroplethr-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-choroplethr
# for installing globally
pixi global install r-choroplethr
```
...
It is possible to list all of the versions of `r-choroplethr` available on your platform:
...
```
pixi search r-choroplethr --channel conda-forge
```
